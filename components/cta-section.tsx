    ...
    <section className="py-20 bg-primary/5">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        <div className="text-center max-w-4xl mx-auto">
          <h2 className="text-3xl sm:text-4xl font-heading font-bold text-foreground mb-6">The CMRAgent™ Advantage</h2>
          ...
          <div className="bg-blue-50 border border-blue-200 rounded-lg p-6 mb-8 text-left">
            <div className="flex items-start gap-3">
              ...
              <div>
                <h3 className="font-semibold text-blue-900 mb-2">Transparency: Why CMRAgent™ Exists</h3>
                ...
                <p className="text-blue-800 text-sm leading-relaxed">
                  <strong>Our Solution:</strong> CMRAgent™ is our proprietary AI that acts as an authorized employee,
