// Temporary stub for lucide-react icons to fix import errors in preview
// These will be replaced with actual lucide-react when deployed
...
export const Loader2 = (props: any) => (
  <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24" className={`${props.className} animate-spin`}>
    <path
      strokeLinecap="round"
      strokeLinejoin="round"
      strokeWidth={2}
